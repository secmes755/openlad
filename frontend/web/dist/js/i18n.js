...
const I18N_DICT = {
    ...
    "chat.pageImageUnavailable": { zh: "页图不可用（该文档未生成此页的图像）", en: "Page image unavailable (no render for this page)" },
    ...
    "misc.prevPage":             { zh: "上一页", en: "Previous page" },
    "misc.nextPage":             { zh: "下一页", en: "Next page" },
