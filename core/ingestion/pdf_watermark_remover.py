...
class ContentStreamAnalyzer:
    ...
    @classmethod
    def _extract_text_matrix(cls, block_data: bytes) -> dict | None:
        """
    ...
    @classmethod
    def _extract_font_info(cls, block_data: bytes) -> dict | None:
    ...
    @classmethod
    def _extract_color_info(cls, block_data: bytes) -> dict | None:
        """
...
class WatermarkDetector:
    ...
    def _create_signature(self, block: dict, features: dict) -> str | None:
...
class PDFWatermarkRemover:
    ...
    def __init__(self, detector: WatermarkDetector | None = None):
